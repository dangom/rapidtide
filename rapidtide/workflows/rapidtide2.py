...
def _get_parser():
    ...
    parser.add_argument("prefix", help="The root name for the output files")
    ...
    preproc.add_argument(
        ...
        metavar="ORDER",
        help=(
            "Use butterworth filter for band splitting "
    ...
    wfunc.add_argument(
        ...
        help=(
            "Window funcion to use prior to correlation. "
    ...
    preproc.add_argument(
        ...
        type=float,
        metavar="GAUSSSIGMA",
        help=("Spatially filter fMRI data prior to analysis " "using GAUSSSIGMA in mm"),
        default=0.0,
    )
    preproc.add_argument(
        "-M",
    ...
    exp_group.add_argument(
        ...
        dest="saveprewhiten",
        action="store_true",
        help=("Save prewhitened data (turns prewhitening " "on)"),
        default=False,
    )
    experimental.add_argument(
        "--AR",
...
def rapidtide_workflow(
    ...
    arbvec: Optional[Tuple[float, float]] = None,
    filtertype="arb",
    ...
    slicetimes: Optional[str] = None,
    preprocskip: int = 0,
    nothresh: bool = True,
    oversampfactor: int = 2,
    regressorfile: Optional[str] = None,
    inputfreq: float = 1.0,
    inputstarttime: float = 0.0,
    corrweighting: str = "none",
    dodetrend: bool = True,
    corrmaskthreshpct: float = 1.0,
    corrmaskname: Optional[str] = None,
    fixeddelayvalue: Optional[float] = None,
    lag_extrema: Tuple[float, float] = (-30.0, 30.0),
    widthlimit: float = 100.0,
    bipolar: bool = False,
    zerooutbadfit: bool = True,
    findmaxtype: str = "gauss",
    despeckle_passes: int = 0,
    despeckle_thresh: int = 5,
    refineprenorm: str = "mean",
    refineweighting: str = "R2",
    passes: int = 1,
    includemaskname: Optional[str] = None,
    excludemaskname: Optional[str] = None,
    lagminthresh: float = 0.5,
    lagmaxthresh: float = 5.0,
    ampthresh: float = 0.3,
    sigmathresh: float = 100.0,
    refineoffset: bool = False,
    psdfilter: bool = False,
    lagmaskside: str = "both",
    refinetype: str = "avg",
    savelagregressors: bool = True,
    savecorrtimes: bool = False,
    histlen: int = 100,
    timerange: Tuple[int, int] = (-1, 10000000),
    glmsourcefile: Optional[str] = None,
    doglmfilt: bool = True,
    preservefiltering: bool = False,
    showprogressbar: bool = True,
    dodeconv: bool = False,
    internalprecision: str = "double",
    isgrayordinate: bool = False,
    fakerun: bool = False,
    ...
    fix_autocorrelation: bool = False,
    tmaskname: Optional[str] = None,
    doprewhiten: bool = False,
    saveprewhiten: bool = False,
    armodelorder: int = 1,
    offsettime_total: Optional[float] = None,
    ampthreshfromsig: bool = False,
    nohistzero: bool = False,
    fixdelay: bool = False,
    usebutterworthfilter: bool = False,
):
    """
...
def _main(argv=None):
    ...
    if args["arbvec"] is not None:
        if len(args["arbvec"]) == 2:
            ...
            raise ValueError(
                "Argument '--arb' (or '-F') must be either two " "or four floats."
            )
